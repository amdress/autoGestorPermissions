...
it('tem a página do categorycontroller', function () {
    // Criar uma permissão e um papel
    $permission = Permission::create(['name' => 'view categories']);  // A permissão necessária
    ...
    $response = $this->actingAs($user)->get('/categories');  // Realiza a solicitação como um usuário autenticado
