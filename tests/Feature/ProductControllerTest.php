...
it('tem a página do productcontroller', function () {
    // Criar uma permissão e um papel
    $permission = Permission::create(['name' => 'view products']);  // A permissão necessária
    ...
    $response = $this->actingAs($user)->get('/products');  // Realiza a solicitação como um usuário autenticado
