        ...
        <table class="w-full">
            ...
            <tbody class="bg-white">
                ...
                <tr>
                    ...
                    <td class="px-6 py-3 text-left"> {{ \Carbon\Carbon::parse($permission->create_at)->format('d M, Y') }} </td>
                    <td class="px-6 py-3 text-center">
                        ...
                        {{-- delete  --}}
                        <a href="javascript:void(0)" onclick="deletePermission({{$permission->id}})" class="bg-red-700 text-sm rounded-md text-white px-3 py-2 hover:bg-red-500">Delete</a>
